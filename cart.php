...
<!--            <div class="cartone">-->
<!--                <div class="cartimg">-->
<!--                    <img src="image/prdct12.png" alt="product1">-->
<!--                </div>-->
<!--                <div class="cartdiscp">-->
<!--                    <h3>DRAGONFLY</h3>-->
<!--                    <h4 id="dragonflyPrice" price="22">$22.00/ea</h4>-->
<!--                </div>-->
<!--                <div class="cartnumberadd" align="center">-->
<!--                    <label>-->
<!--                        <select class="cart_items" each_price=22 onChange="calculatePrice()">-->
<!--                            <option value=0>0</option>-->
<!--                            <option selected="selected" value=1>1</option>-->
<!--                            <option value=2>2</option>-->
<!--                            <option value=3>3</option>-->
...
<!--                    </label>-->
<!--                </div>-->
<!--                <div class="cartprice" id="price1" align="center">-->
<!--                    $22.00-->
<!--                </div>-->
<!--            </div>-->
<!---->
...
<!--            <div class="cartone">-->
<!--                <div class="cartimg">-->
<!--                    <img src="image/prdct5.png" alt="product1">-->
<!--                </div>-->
<!--                <div class="cartdiscp">-->
<!--                    <h3>BUZZWORTHY </h3>-->
<!--                    <h4 id="buzzworthyPrice" price="26.00">$26/ea</h4>-->
<!--                </div>-->
<!--                <div class="cartnumberadd" align="center">-->
<!--                    <label>-->
<!--                        <select class="cart_items" each_price=26 onChange="calculatePrice()">-->
<!--                            <option value=0>0</option>-->
<!--                            <option selected="selected" value=1>1</option>-->
<!--                            <option value=2>2</option>-->
<!--                            <option value=3>3</option>-->
...
<!--                    </label>-->
<!--                </div>-->
<!--                <div class="cartprice" id="price2" align="center">-->
<!--                    $26.00-->
<!--                </div>-->
<!--            </div>-->
<!---->
...
<!--            <div class="cartone">-->
<!--                <div class="cartimg">-->
<!--                    <img src="image/upslogo1.png" alt="product1">-->
<!--                </div>-->
<!--                <div class="cartdiscp">-->
<!--                    Free Delivery $0.00-->
<!---->
...
<!--                <div class="cartnumberadd" align="center">-->
<!--                    <label>-->
<!--                        <select class="cart_items" each_price=0 onChange="calculatePrice()">-->
<!--                            <option value=0>0</option>-->
<!--                            <option selected="selected" value=1>1</option>-->
<!--                            <option value=2>2</option>-->
<!--                            <option value=3>3</option>-->
...
<!--                    </label>-->
<!--                </div>-->
<!--                <div class="cartprice" id="price3" align="center">-->
<!--                    $0.00-->
<!--                </div>-->
            </div>
